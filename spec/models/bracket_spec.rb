...
describe Bracket do
  ...
  context "Starting selection" do
    ...
    it "should populate round one picks with tournament teams" do
      ...
      picks[4].team1.should == "Team 6"
      picks[4].team2.should == "Team 11"
      picks[5].team1.should == "Team 3"
      picks[5].team2.should == "Team 14"
      ...
      picks[12].team1.should == "Team 23"
      picks[12].team2.should == "Team 28"
      picks[13].team1.should == "Team 20"
      picks[13].team2.should == "Team 31"
      ...
      picks[20].team1.should == "Team 40"
      picks[20].team2.should == "Team 45"
      picks[21].team1.should == "Team 37"
      picks[21].team2.should == "Team 48"
      ...
      picks[28].team1.should == "Team 57"
      picks[28].team2.should == "Team 62"
      picks[29].team1.should == "Team 54" 
      picks[29].team2.should == "Team 65"
